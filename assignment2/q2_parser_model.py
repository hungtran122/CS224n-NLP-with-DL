...
class ParserModel(Model):
    ...
    def add_prediction_op(self):
        ...
        # self.dropout_placeholder = 1-self.config.dropout
    ...
    def add_loss_op(self, pred):
        ...
        """
        ### YOUR CODE HERE
        loss = tf.reduce_mean(tf.nn.softmax_cross_entropy_with_logits(labels=self.labels_placeholder,logits=self.pred))
        # loss = tf.reduce_mean(q1_softmax.cross_entropy_loss(self.labels_placeholder,q1_softmax.softmax(self.pred)))
        ### END YOUR CODE
        return loss
